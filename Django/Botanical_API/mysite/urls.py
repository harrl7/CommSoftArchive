...
urlpatterns = [
    ...
    url(r'^speciesInstances/$', views.SpeciesInstanceList.as_view()),

    url(r'^species/(?P<pk>[0-9]+)/$', views.SpeciesDetail.as_view()),
    url(r'^speciesInstances/(?P<pk>[0-9]+)/$', views.SpeciesInstanceDetail.as_view()),
    url(r'^collections/(?P<pk>[0-9]+)/$', views.CollectionDetail.as_view()),

    url(r'^searchItems/$', views.SearchItems.as_view()),
]
